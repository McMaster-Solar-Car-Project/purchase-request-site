...
def create_test_user(name: str, email: str, personal_email: str, address: str, team: str):
    ...
    try:
        ...
        print(f"   Signature Size: {len(user.signature_data) if user.signature_data else 0} bytes")
