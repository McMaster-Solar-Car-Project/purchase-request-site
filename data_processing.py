...
def create_excel_report(user_info, submitted_forms, session_folder):
    ...
    output_filename = f"purchase_requests_{user_info['name'].replace(' ', '_').lower()}.xlsx"
    ...
    for form in submitted_forms:
        ...
        if tab_name not in wb.sheetnames:
            print(f"Warning: Tab '{tab_name}' not found in template, skipping form {form['form_number']}")
            continue
