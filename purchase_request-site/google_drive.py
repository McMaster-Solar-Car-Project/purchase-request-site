...
class GoogleDriveClient:
    ...
    def _authenticate(self):
        ...
        try:
            ...
            logger.info("Successfully authenticated with Google Drive API using environment variables")
            return True
    ...
    def _ensure_parent_folder(self) -> str:
        ...
        try:
            ...
            logger.info(f"Using parent folder: {folder_name} (ID: {self.parent_folder_id})")
    ...
    def _upload_file(self, file_path: str, folder_id: str, file_name: str = None) -> str:
        """
    ...
    def upload_session_folder(self, session_folder_path: str, user_info: Dict[str, Any]) -> bool:
        """
        ...
        try:
            ...
            session_folder_id = self._create_session_folder(drive_folder_name, parent_folder_id)
            ...
            logger.info(f"Successfully uploaded session folder to Google Drive:")
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Successfully connected to Google Drive")
...
def upload_session_to_drive(session_folder_path: str, user_info: Dict[str, Any]) -> bool:
    """
